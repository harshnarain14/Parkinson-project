...
import com.harsh.parkinson.fragment.DashboardFragment
import com.harsh.parkinson.fragment.FaqsFragment
import com.harsh.parkinson.fragment.ProfileFragment
...
class Dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navigationView.setNavigationItemSelectedListener {
            ...
            when (it.itemId) {
                ...
                R.id.orderHistory -> {
                    val intent = Intent(this, TremorDataHistory::class.java)
                    drawerLayout.closeDrawers()
                    Toast.makeText(this@Dashboard, "data History", Toast.LENGTH_SHORT).show()
    ...
    fun openDashboard() {
        ...
        supportActionBar?.title = "Tremors Data"
